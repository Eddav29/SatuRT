...
<div class="px-8">         
    <div class="rounded-lg bg-white px-6 py-0">
      <section>
        <div class="py-6">
          <p class="text-[20px] uppercase tracking-wide rounded-xl py-4 px-4 bg-blue-100 text-left  font-semibold text-navy-night">EDIT DATA UMKM</p>
        </div>
      </section>
        ...
        <form method="POST" action="{{url('umkm')}}" class="space-y-4">
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Pemilik</p>
            <select class="form-control w-full rounded-lg border-gray-200 p-3 text-sm" id="penduduk_id" name="penduduk_id" required>
              <option class="hidden" value="{{old('pemilik',$umkm->penduduk->nama)}}">{{$umkm->penduduk->nama}}</option>
          ...
          @enderror
            ...
            <div>
              ...
              <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Nama UMKM</p>
              <input
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Jenis UMKM</p>
                <select class="form-control w-full rounded-lg border-gray-200 p-3 text-sm" id="jenis_umkm" name="jenis_umkm" required>
                  <option class="hidden" value="{{old('jenis_umkm',$umkm->jenis_umkm)}}">{{$umkm->jenis_umkm}}</option>
              ...
              <div>
                ...
                <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Alamat</p>
                <input
                  class="placeholder-gray-300 w-full rounded-lg border-gray-200 p-3 text-sm"
                  placeholder="Alamat"
                  type="text"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Nomor Telepon</p>
                <input
                  class="placeholder-gray-300 w-full rounded-lg border-gray-200 p-3 text-sm"
              ...
              <div>
                ...
                <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Lokasi URL</p>
                <input
                  class="placeholder-gray-300 w-full rounded-lg border-gray-200 p-3 text-sm"
                  placeholder="Lokasi URL"
                  type="text"
                  id="lokasi_url"
              ...
              <div>
                  <label for="status" class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Status UMKM</label>
                  <select id="status" class="placeholder-gray-300 w-full rounded-lg border-gray-200 p-3 text-sm">
                      <option class="hidden" value="{{old('status', $umkm->status)}}">{{$umkm->status}}</option>
                      <option value="Aktif">Aktif</option>
                      <option value="Nonaktif">Nonaktif</option>
                  </select>
              </div>
              
              <p class="py-2 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-navy-night">Surat Izin Usaha</p>
              <div class="flex items-center justify-center w-full">
                <label for="lisence_image_url" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 rounded-lg cursor-pointer bg-white-50 hover:bg-bray-100  hover:border-gray-100 hover:bg-gray-200">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p class="mb-2 text-sm text-gray-300 dark:text-gray-300"><span class="font-semibold">Unggah Surat Izin Usaha</span></p>
                    </div>
            ...
            <div class="flex items-center justify-center w-full">
                <label for="thumbnail_url" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 rounded-lg cursor-pointer bg-white-50 dark:hover:bg-bray-100  hover:border-gray-100 hover:bg-gray-200">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        <svg class="w-8 h-8 mb-4 text-gray-300 dark:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                        </svg>
                        ...
                        <p class="mb-2 text-sm text-gray-300 dark:text-gray-300"><span class="font-semibold">Unggah Thumbnail</span></p>
                    </div>
                    <input id="thumbnail_url" type="file" class="hidden" onchange="renderFiles(this.files, 'thumbnail_url')" />
                </label>
            </div>
