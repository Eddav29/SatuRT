              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div class="flex items-center justify-center w-full">
                    <label for="lisence_image_url" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 rounded-lg cursor-not-allowed bg-white">
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="thumbnail_url" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 rounded-lg cursor-not-allowed bg-white">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <div>
                    ...
                    class=" font-semibold text-navy-night">Keterangan
                    </label>
                @error('keterangan')
