    ...
    <div class="p-6 lg:px-14 gap-y-5 mx-auto max-w-screen-2xl md:p-6 2xl:p-10 ">
        <div class="p-6 rounded-xl bg-white-snow overflow-hidden">
            ...
            <section>
                ...
                <div class="mx-3 my-10 max-lg:text-center lg:text-right">
                    <button id="setuju" class="bg-green-500 text-white px-4 py-2 rounded-md">Setujui</button>
                    <button id="tolak" class="bg-red-500 text-white px-4 py-2 rounded-md">Tolak</button>
                </div>
            </section>
            {{-- End Table --}}
        </div>
