<x-guest-layout>
    ...
    <div class="flex flex-col gap-y-10 w-full max-w-7xl mx-auto">
            ...
            <section>
                <a href="{{ route('berita-detail', $newInformation->informasi_id) }}" class="group">
                    <div class="relative h-72 lg:h-[85vh]">
                        <img src="{{ 'storage/information_images/' . $newInformation->thumbnail_url ?? '' }}"
                        ...
                        <div
                            ...
                            @php
                                $judul = Str::limit($newInformation->judul_informasi, 40, '...');
                            @endphp
        ...
        @if ($informations && count($informations) > 0)
            {{-- News --}}
            <section>
                @php
                ...
                @if ($informations->count() > 0)
                    <div class="flex flex-col gap-y-10 lg:grid lg:grid-cols-4 lg:auto-rows-fr lg:gap-x-5">
                        @foreach ($informations as $key => $information)
                            @php
                                $judul = Str::limit($information->judul_informasi, 40, '...');
                            @endphp
                ...
                @else
                    <p
                        class="text-center text-navy-night text-[1rem]/[1.618rem] border border-green-light py-5 rounded-xl">
                        Data Tidak
                        Tersedia</p>
                @endif
            </section>
        ...
        @else
            <section>
                <div class="flex flex-col gap-y-10 w-full max-w-7xl mx-auto"></div>
                <div class="w-full">
                    <p
                        class="text-center text-navy-night text-[1rem]/[1.618rem] border border-green-light py-5 rounded-xl">
                        Data Tidak
